...
namespace CommonTools.StringHelper
{
    public partial class StringHelper
    {
        ...
        private static string GetX(int gbCode)
        {
            ...
            if (gbCode < 5601 || gbCode > 8794) return " ";
            const string codeData = "cjwgnspgcenegypbtwxzdxykygtpjnmjqmbsgzscyjsyyfpggbzgydywjkgaljswkbjqhyjwpdzlsgmr"
            ...
            var gbcode = gbCode.ToString();
            var pos = (Convert.ToInt16(gbcode.Substring(0, 2)) - 56) * 94 + Convert.ToInt16(gbcode.Substring(gbcode.Length - 2, 2));
            ...
            var sA = new[]
    {
     ...
     ,"zhun","zhuo","zi","zong","zou","zu","zuan","zui","zun","zuo"
            ...
            foreach (var t in c)
            {
                var b = Encoding.Default.GetBytes(t.ToString());
